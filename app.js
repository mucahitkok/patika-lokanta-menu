...
// Dom'da çalışacağımız elementleri seçelim

let buttonsDom = document.querySelector(".btn-container"); //html'deki şuanlık boş olan div'imiz
let sectionDom = document.querySelector(".section-center");//html'deki şuanlık boş olan içerik kısmı



// Butonları creat etme
...
// id ve dom'da gözükecek isimleri burda oluşturduk
// ayrıca butonlara click olduğunda çalışacak fonksiyonları atadık

function addButton() {
  buttonsDom.innerHTML = createButton("All") + " " + createButton("Korea") + " " + createButton("Japan") + " " + createButton("China")
...
// sayfa açıldığında butonların ve bütün listeleri açık bir şekilde yükledik
